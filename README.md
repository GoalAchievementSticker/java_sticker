...
1. **챌린지 탐색 및 참여**
   ...
   - 챌린지 모집 인원이 마감되었거나, 개설자가 모집을 마감했을 경우 참여할 수 없습니다.
     <br>
     <img src="./better_me/images/main.png" alt="메인화면" width="200"/>
     <img src="./images/search.png" alt="탐색화면" width="200"/>
     <img src="./images/참가하기.png" alt="참가하기" width="200"/>
     <br>
 
2. **도장판 활용**
   - 참여한 챌린지의 도장판에 스티커를 추가하여 진행 상황을 기록
    <br>
    <img src="./images/도장찍기.png" alt="도장찍기" width="200"/>
    <img src="./images/참가세부정보.png" alt="세부정보" width="200"/>
    <br>
